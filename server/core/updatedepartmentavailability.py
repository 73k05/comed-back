...
while 1 == 1:
    ...
    # Load department availability List
    with open('../../frontend/resources/json/departmentavailabilities.json') as json_data:
        departmentList = json.load(json_data)["bookings"]

    nbRequestSent += 1

    # Check all prefs
    for booking in departmentList:
