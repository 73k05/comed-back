...
def createBody(date_free_slot, booking):
    ...
    content += f"<b>Si on vous a rendu service, nous avons besoin de vos 5 étoiles sur <a href='https://fr.trustpilot.com/review/www.commissionmedicale.fr'>Trustpilot</a></b><br/>"
